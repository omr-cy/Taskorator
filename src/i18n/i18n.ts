...
const translationsZH: Record<TranslationKey, string> = {
    ...
    'settings.template.preview': '显示预览',
    'settings.template.hide': '隐藏预览',
    ...
    'settings.template.vars.desc': '{{date}} - 日期, {{date-with-icon}} - 图标日期, {{weekday}} - 星期, {{time}} - 时间, {{weekday-ar}} - 阿拉伯语星期, {{weekday-zh}} - 中文星期, {{month-ar}} - 阿拉伯语月份, {{month-zh}} - 中文月份',
...
const translationsEN: Record<TranslationKey, string> = {
    ...
    'settings.basicSettings': 'Interface language',
    ...
    'settings.template.vars.desc': '{{date}} - Date, {{date-with-icon}} - Icon date, {{weekday}} - Weekday, {{time}} - Time, {{weekday-ar}} - Arabic weekday, {{weekday-zh}} - Chinese weekday, {{month-ar}} - Arabic month, {{month-zh}} - Chinese month',
...
const translationsAR: Record<TranslationKey, string> = {
    ...
    'settings.template.preview': 'عرض المعاينة',
    'settings.template.hide': 'إخفاء المعاينة',
    ...
    'settings.basicSettings': 'لغة الواجهة',
    ...
    'settings.template.vars.desc': '{{date}} - التاريخ, {{date-with-icon}} - أيقونة التاريخ, {{weekday}} - اليوم, {{time}} - الوقت, {{weekday-ar}} - اليوم بالعربية, {{weekday-zh}} - اليوم بالصينية, {{month-ar}} - الشهر بالعربية, {{month-zh}} - الشهر بالصينية',
