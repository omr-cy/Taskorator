...
const translationsZH: Record<TranslationKey, string> = {
    ...
    'settings.template.tags.desc': '支持：#every-day, #every-workday (及 -ar), #every(mon, sun), #every(jan(1,15))',
...
const translationsEN: Record<TranslationKey, string> = {
    ...
    'settings.template.tags.desc': 'Support: #every-day, #every-workday (-ar), #every(mon, sun), #every(month(1,15))',
...
const translationsAR: Record<TranslationKey, string> = {
    ...
    'settings.template.tags.desc': 'دعم: #every-day, #every-workday (-ar), #every(mon, sun), #every(month(1,15))',
